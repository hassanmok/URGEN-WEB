      ...
      <div className="container-urgen py-12 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-slate-300">{m.footer.blurb}</p>
          </div>

          <div>
            <p className="text-sm font-bold text-white">{m.footer.quickLinks}</p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-300">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+9647818220220" className="hover:text-white" dir="ltr">
                  +9647818220220
                </a>
                <a href="tel:+9647718220220" className="hover:text-white" dir="ltr">
                  +9647718220220
                </a>
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="rounded-xl bg-white p-2 shadow-inner">
                <img src="/qr-placeholder.svg" alt="" width={88} height={88} className="block" />
              </div>
              <p className="max-w-40 text-xs leading-relaxed text-slate-400">{m.footer.qrHint}</p>
            </div>
          </div>
        </div>
